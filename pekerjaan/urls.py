...
from .views import create_pekerjaan, read_pekerjaan, update_pekerjaan, create_bekerja, read_bekerja, delete_pekerjaan
...
urlpatterns = [
	...
	path('delete/pekerjaan/<str:nama>', delete_pekerjaan, name='delete_pekerjaan'),
